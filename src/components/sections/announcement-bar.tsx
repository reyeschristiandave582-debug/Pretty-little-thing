...
const AnnouncementBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 w-full bg-[#f1c59e] border-b border-[#f1c59e]/30 py-1.5 px-4 shadow-[0_4px_20px_rgba(0,0,0,0.3)] backdrop-blur-md">
        ...
        <div className="flex items-center justify-center gap-3">
            <div className="flex items-center justify-center gap-2 text-center">
              ...
              <p className="text-[#ffffff] text-[12px] font-bold tracking-tight text-center">
                ...
                minutes left to unlock your Pretty Little Thing reward
              </p>
            </div>
        </div>
